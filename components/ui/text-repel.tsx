...
interface TextRepelProps {
    ...
    strength?: number;
    /** Interaction mode â€” push letters away or pull them toward the cursor */
    mode?: "repel" | "attract";
    /** Spring stiffness â€” higher = snappier return */
    stiffness?: number;
    /** Spring damping â€” lower = bouncier return */
    damping?: number;
    /** Spring mass â€” higher = heavier feel */
    mass?: number;
}
